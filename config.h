...
static const char col_gray1[]       = "#44475a"; /* bar background color */
static const char col_gray2[]       = "#282a36"; /* unfocused border */
static const char col_gray3[]       = "#f8f8f2";
static const char col_gray4[]       = "#282a36"; /* focused color */
static const char col_cyan[]        = "#50fa7b"; /* bar tags */
...
/* tagging */
static const char *tags[] = { "shell", "www", "whatsapp", "files", "steam", "vbox", "code", "edit", "extra" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_i,      spawn,          {.v = browsecmd } },
	{ MODKEY|ShiftMask,             XK_y,      spawn,          {.v = calccmd } },
